...
<script>
  ...
  export default {
    ...
    props: {
      ...
      colors: {
        type: Array,
        default: () => chartColors.gauge.colors
      },
      gaugeTitle: {
        type: String,
        default: '仪表盘'
      ...
      gaugeTitleColor: {
        type: String,
        default: chartColors.gauge.title
      },
      detailTextShadowColor: {
        type: String,
        default: chartColors.gauge.detailTextShadow
      },
      shadowColor: {
        type: String,
        default: chartColors.gauge.shadow
      },
      detailColor: {
        type: String,
        default: chartColors.gauge.detail
      }
    },
    data() {
      return {
